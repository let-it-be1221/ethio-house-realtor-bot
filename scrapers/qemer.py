"""Scraper for Qemer Real Estate - Ethiopian property listing platform."""
...
class QemerScraper(BaseScraper):
    """Scraper for qemer.com (or similar) Ethiopian property listings."""

    def __init__(self):
        super().__init__()
        self.source_name = "qemer"
        self.base_url = "https://qemer.com"
        self.listing_pages = [
            ...
            try:
                ...
                for link in soup.find_all("a", href=True):
                    ...
                    if any(pattern in href for pattern in ["/property/", "/listing/", "/properties/"]):
                        ...
                        if full_url not in all_urls and not full_url.endswith(("/properties/", "/listings/")):
    ...
    def scrape_listing(self, url: str) -> Optional[Dict]:
        ...
        try:
            ...
            for tag in soup.find_all(["span", "div"], class_=re.compile(r"price", re.I)):
