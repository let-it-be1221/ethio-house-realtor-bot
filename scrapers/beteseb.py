"""Scraper for Beteseb.com - Ethiopian real estate and home listing platform."""
...
class BetesebScraper(BaseScraper):
    """Scraper for beteseb.com property listings."""

    def __init__(self):
        super().__init__()
        self.source_name = "beteseb"
        self.base_url = "https://beteseb.com"
        self.listing_pages = [
